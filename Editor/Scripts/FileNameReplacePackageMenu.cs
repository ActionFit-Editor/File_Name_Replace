...
public static class FileNameReplacePackageMenu
{
    private const string MenuRoot = "Tools/Package/File Name Replace/";
    private const string ReadmePath = "Packages/com.actionfit.filenamereplace/README.md";
